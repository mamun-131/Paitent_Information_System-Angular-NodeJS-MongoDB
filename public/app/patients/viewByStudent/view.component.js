System.register(["@angular/core", "@angular/router", "../../authentication/authentication.service", "../articles.service"], function (exports_1, context_1) {
    ...
    var core_1, router_1, authentication_service_1, articles_service_1, ViewByStudentComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ViewByStudentComponent = /** @class */ (function () {
                //
                function ViewByStudentComponent(_router, _route, _authenticationService, _articlesService) {
                ...
                //
                ViewByStudentComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ...
                    this.paramsObserver = this._route.params.subscribe(function (params) {
                        ...
                        _this._articlesService
                            ...
                            _this.patient = article['0'].patientId;
                            //  console.log(this.patient['patientId']);
                            // console.log("cccc");
                            _this._articlesService
                                .infoByPatientID(_this.patient)
                ...
                //
                ViewByStudentComponent.prototype.ngOnDestroy = function () {
                    this.paramsObserver.unsubscribe();
                };
                //
                ViewByStudentComponent.prototype.delete = function () {
                    var _this = this;
                ...
                ViewByStudentComponent = __decorate([
                    core_1.Component({
                ...
                return ViewByStudentComponent;
            }());
            exports_1("ViewByStudentComponent", ViewByStudentComponent);
        }
    };
});
